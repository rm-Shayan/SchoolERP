...
- Name: Frontend\tests\orgadmin-ui.spec.ts >> Org Admin UI Flow >> Fee Structures Page >> fee structures page has correct heading
- Location: Frontend\tests\orgadmin-ui.spec.ts:120:9
...
Locator: getByRole('heading', { name: 'Fee Structures', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Fee Structures', exact: true })
