...
- Name: Frontend\tests\orgadmin-ui.spec.ts >> Org Admin UI Flow >> Attendance Pages >> attendance records page loads with tabs
- Location: Frontend\tests\orgadmin-ui.spec.ts:146:9
...
Call log:
  ...
  - waiting for getByText('Daily View')
