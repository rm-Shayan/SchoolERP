...
- Name: Frontend\tests\orgadmin-ui.spec.ts >> Org Admin UI Flow >> Admissions Page >> admissions page loads
- Location: Frontend\tests\orgadmin-ui.spec.ts:169:9
...
Locator: getByRole('heading', { name: 'Admissions' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Admissions' })
