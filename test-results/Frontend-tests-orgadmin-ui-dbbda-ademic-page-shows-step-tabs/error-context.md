...
- Name: Frontend\tests\orgadmin-ui.spec.ts >> Org Admin UI Flow >> Academic Page >> academic page shows step tabs
- Location: Frontend\tests\orgadmin-ui.spec.ts:101:9
...
Locator: getByRole('heading', { name: 'Academic Setup' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Academic Setup' })
