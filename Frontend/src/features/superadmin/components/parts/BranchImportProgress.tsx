    ...
    return (
      <div className="mt-6">
        <div className="flex items-center justify-between text-sm mb-2">
          <span className="text-gray-600 font-medium">Importing branches…</span>
    ...
    return (
      <div className="mt-6 flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
        ...
        <div className="text-sm text-green-800">
          ...
          <p className="mt-0.5">
            Branches are ready. Branch admin credentials (if any AdminEmail was provided) were emailed.
          </p>
          <Link
              href="/admin/branches"
