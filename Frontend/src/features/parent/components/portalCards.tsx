...
export function PortalHeader({ title, subtitle, onLogout }: PortalHeaderProps) {
  ...
  return (
    ...
    >
      {!color && <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600" />}
...
export function PortalInfoCards() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <InfoCard icon="attendance" title="Attendance" note="Daily check-in/check-out and absence alerts delivered by email." color="#22c55e" />
