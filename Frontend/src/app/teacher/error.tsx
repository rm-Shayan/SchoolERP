...
export default function TeacherError({ error, reset }: ErrorProps) {
  useEffect(() => { console.error('Teacher portal error:', error); }, [error]);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4 text-center">
      ...
      <h1 className="mt-6 text-3xl font-black tracking-tight text-slate-900">Teacher page error</h1>
      <p className="mt-3 max-w-md text-base leading-7 text-slate-500">
        This teacher page couldn&apos;t load. Please try again or return to the dashboard.
      </p>
      ...
      <div className="mt-8 flex gap-3">
        ...
        <Link href="/teacher/dashboard" className="inline-flex items-center gap-2 rounded-xl bg-primary-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-700">
          Go to Dashboard
        </Link>
      </div>
    </div>
