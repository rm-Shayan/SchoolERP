...
function toBody(d: PTMPayload): Record<string, unknown> {
  return {
    ...
    location: d.venue,
    scope: d.scope,
    classFromId: d.classFromId || undefined,
    classToId: d.classToId || undefined,
    sectionIds: d.sectionIds && d.sectionIds.length ? d.sectionIds : undefined,
